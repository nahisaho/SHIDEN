...
import { createCurriculumCommand } from './commands/curriculum.js';
...
� 学習指導要領の活用 (v0.4.0 NEW!):
  小学校・中学校・高等学校の学習指導要領（2,469セクション）を内蔵！
  授業計画や教材作成時に、学習指導要領に準拠した内容を参照できます。

  検索コマンド:
  npx shiden curriculum search "二次方程式"    # キーワード検索
  npx shiden curriculum search "読解" --limit 5 # 結果数指定
  npx shiden curriculum stats                    # 統計表示

  ┌─────────────────────────────────────────────────────┐
  │ 📖 小学校学習指導要領: 538セクション                │
  │ 📖 中学校学習指導要領: 560セクション                │
  │ 📖 高等学校学習指導要領: 1,371セクション            │
  └─────────────────────────────────────────────────────┘
...
function main(): void {
  ...
  // curriculum サブコマンドを追加
  program.addCommand(createCurriculumCommand());
